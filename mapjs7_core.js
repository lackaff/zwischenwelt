...
function CreateMap() {
	...
	if (!gBig)	gMapHTML += "<a href=\"javascript:OpenMap(6)\"><img alt=\"firemap\" title=\"firemap\" border=0 src=\""+g("icon/firemap.png")+"\"></a>";
	gMapHTML += "</div>";
	gMapHTML += "<ul>";
...
function OpenMap (type) {
	...
	if (type == 1) { // bigmap
		...
		window.open("minimap.php?mode=fire&sid="+gSID+"&cx="+x+"&cy="+y,"FireMap","location=no,menubar=no,toolbar=no,status=no,resizable=yes,scrollbars=yes");
